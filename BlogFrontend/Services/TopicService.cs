...
namespace BlogFrontend.Services
{
    public class TopicService
    {
        ...
        public async Task<IEnumerable<Topic>> GetTopicsAsync()
        {
            ...
            return await _httpClient.GetFromJsonAsync<IEnumerable<Topic>>("http://135.236.156.195/api/Topic/GetAllTopics");
        }
        ...
        public async Task<bool> CreatePreferencesAsync(Guid userId, List<int> selectedTopics)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync($"http://135.236.156.195/api/Topic/AssignTopicsToUser/{userId}", selectedTopics);
